class PatientSearch
{
   ...
   async ClickOnSaveButtonForUnknownPatient()
   {
    ...
    {
        const elem=await this.txtbox_MPINumber.type(name)
        if(elem!=null)
        {
            return elem;
        }
    ...
    {
        const elem=await this.txtbox_GivenName.type(name)
        if(elem!=null)
        {
            return elem;
        }
    ...
    {
        const elem=await this.txtbox_Barcode.type(name)
        if(elem!=null)
        {
            return elem;
        }
    ...
    {
        const elem=await this.txtbox_FamilyName.type(name)
        if(elem!=null)
        {
            return elem;
        }
    ...
    {
        const elem=await this.txtbox_HospitalRef.type(name)
        if(elem!=null)
        {
            return elem;
        }
    ...
    {
        const elem=await this.txtbox_MobileNumber.type(name)
        if(elem!=null)
        {
            console.log("Element not found");            
        }
    ...
    {
        const elem=await this.txtbox_Postcode.type(name)
        if(elem!=null)
        {
            console.log("Element not found");            
        }
    ...
    {
        const elem=await this.txtbox_IdentificationId.type(name)
        if(elem!=null)
        {
            console.log("Element not found");            
        }
    ...
    {
        const elem=await this.txtbox_MRNNumber.type(name)
        if(elem!=null)
        {
            console.log("Element not found");            
        }
    ...
    {
        const elem=await this.txtbox_PatNameInOtherLang.type(name)
        if(elem!=null)
        {
            console.log("Element not found");            
        }
