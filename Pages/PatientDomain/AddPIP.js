class AddPIP
{
    ...
    {
        this.page=page
        this.dropdown_PIPTitle=page.getByTestId('Title').getByRole('button', { name: '​' })
        ...
        this.dropdown_PIPEthnicity=page.getByTestId('Ethnicity').getByRole('button', { name: '​' })
        this.dropdown_PIPOccupation=page.getByTestId('Occupation').getByRole('button', { name: '​' })
        this.txtbox_PIPMobile=page.getByTestId('Mobile')
        this.txtbox_PIPEmail=page.getByTestId('Email')
        this.dropdown_PIPRelation=page.getByTestId('Relationship').getByLabel('​', { exact: true })                                      
        this.dropdownPIPNextOfkin=page.getByTestId('Next of Kin').getByLabel('​', { exact: true })
