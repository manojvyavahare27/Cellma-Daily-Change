...
test('Create On Referral @Functional @ReferralDomain', async ({ page }) => {
    ...
    await page.pause()
    // await createonreferral.clickOnCompletlyRejectToDelete()
    // await page.getByTestId('Reason').fill('Testing')
    // await page.getByTestId('CommonCellmaPopup').getByTestId('Reject').click()
