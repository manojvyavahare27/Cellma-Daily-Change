...
test('Single Page Registration @Regression', async ({page}) => {
    ...
    //Cellma 3 flow for Single page patient registration page.

    await page.goto('http://10.0.0.84:8080/cellmaWEB/index.do');
    await page.getByPlaceholder('Username').click();
    await page.getByPlaceholder('Username').fill('trainer.dhanu');
   ...
   // await page.pause()
    ...
    // const filePath1 = '../UploadPics/ReferralLetter.docx';  
    // // Upload the file
    ...
    // Set the file to upload
    const filePath2 = '../UploadPics/PatientPic.png';  
    // Upload the file
    await fileInput2.setInputFiles(filePath2);
   

  await singlepage.SelectCountryOfBirth()
   ...
   // await editpatient.selectCurrentlyPregnant()
    ...
    //await page.pause()
    await addpatient.enterPatientNameInOtherLang()
    await addpatient.selectSexualOrientation()
    await addpatient.selectCurrentlyPregnant()
    ...
    await addpatient.enterCountyOfBirth(patientdetailsdata.CountyOfBirth)
    ...
    await addpatient.clickOnResetPasswordLink()
    ...
    await addaddress.selectTempCountry()
   ...
   // await expect(page.getByText('Patient interested party details added successfully')).toHaveText('Patient interested party details added successfully')  
    ...
    await viewpip.EnterPIPInSearch("abc")
  ...
  // await page.locator('#clinicId').getByText('Cardiology').click()
  //   await page.getByRole('button', { name: 'Submit' }).click();
  //   await page.locator('#cliAllowSinglePageRegistration').selectOption('No')
  //   await page.getByRole('button', { name: 'Change Service Details' }).click()
  //   await page.waitForTimeout(3000)
  //   await page.getByRole('img', { name: 'Riomed\'s CELLMA' }).click();    
  //   await page.getByRole('button', { name: 'LOG OUT' }).click();
